...
map('n', '<leader>t', ':Tagbar<CR>', { silent = true })
map('n', '<leader>e', ':ALENext<CR>', { silent = true })
map('n', '<leader>b', ':ALEPrevious<CR>', { silent = true })
...
local function github_link()
    ...
    local repo = vim.fn.system(string.format(
    ...
    local link = string.format(
        ...
        repo, repo_sha, relative, start_line, end_line
    )
